    ...
    $(document).ready(function ()
    {
        ...
        if ($(window).width() > 1024)
        {
            ...
            $('.text-animation').each(function (k, v)
            {
                ...
                var elem = $(this);
                var characters = elem.html().replaceAll('<br>','|').replaceAll('<br />','|').trim().split("");
        ...
        $('#continue-to-site').click(function (e)
        {
            e.preventDefault();
            $('#mobile-overlay-menu').fadeOut(300);
        });

        $('#the-menu-toggle,#menu-toggle-mobile').click(function (e)
        {
            e.preventDefault();
            $('#the-menu').toggleClass('active');
            $('#mobile-header').toggleClass('active');
            $('header').toggleClass('menu-opened');
            $('#the-menu-toggle,#menu-toggle-mobile').toggleClass('active');
        });
